            ...
            <img src="../../../images/icon_removebg.png" alt="logo" class="logo" a onClick="location.href='../../../'">
                <nav>
                    <ul>
                        ...
                        <li><a style="cursor: pointer;" onClick="location.href='../../User/features.php'">FEATURES</a></li>
                        <li><a style="cursor: pointer;" onClick="location.href='../../User/aboutus.php'">ABOUT US</a></li>
                        <li>
