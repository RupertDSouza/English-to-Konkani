...
<head>
    ...
    <link rel="stylesheet" href="../../css/featurestyles.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <section>
        <div class="parent">
            <div class="div1">
                <img src="../../images/HQT_Icon-removebg-preview.png" alt="my image" class="HQTIcon" />
                <br><br>
...
<div id="myModal1" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <p>Retrieve translated results that’s verified by experts involved with the platform.<br>
        ...
        it must be a seamless flow where the translator appears invisible throughout the text.
            ...
            <div class="div2">
                <img src="../../images/microphone-svgrepo-com 1.png" alt="my image" class="HQTIcon2" />
                <br><br>
    ...
    <section> 
        <div class="div3">
                <img src="../../images/Group.png" alt="my image" class="HQTIcon2" />
                <br><br>
            ...
            <div class="div4">
                <img src="../../images/Group-1.png" alt="my image" class="HQTIcon2" />
                <br><br>
    ...
    <script src="../../script/modaltest.js"></script>
</body>
