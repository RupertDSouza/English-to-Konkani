...
require('db.inc.php');
    ...
    //$res=mysqli_query($con1,"INSERT INTO `a`(`Eng`, `Kon`, `gramtyp`) 
                      //VALUES ('".strtolower($add_eng)."','".strtolower($add_kon)."','".strtolower($gram_type)."'");
$res=mysqli_query($con1,"INSERT INTO `$table`(`Eng`, `Kon`, `gramtyp`)VALUES ('".strtolower($add_eng)."','".strtolower($add_kon)."','".strtolower($gram_type)."')");
          header('location:enter_words.php');
          die();
        }
?>
<html lang="en">
        ...
        <form method="post">
             <table>
                ...
                <tr>
                    <td class="sub" >ENG</td>
                     <td>
                        <textarea name="add_eng" id="add_eng" required></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="sub">KON</td>
                    <td ><textarea name="add_kon" id="add_kon" required></textarea>
                    </td>
                </tr>
                <tr>
